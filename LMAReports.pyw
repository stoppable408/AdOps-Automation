...
for site in siteList:
    print(site)
    # if site == "teads.tv" or site == "EMX Digital" or site == "Sabio.us" or site == "QuantCast" or site == "2060 Digital":
        # continue
    if site != "EMX Digital":
        continue
...
MailUtils.send_email(fileList, "LMA Reports", "Attached are the LMA Reports for today", ["Lennon.Turner@carat.com"])
